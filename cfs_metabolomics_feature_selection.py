...
# -----------------------------
print("\n============================================================")
print("Chronic Fatigue Syndrome Metabolomics Analysis")
print("Regularised Logistic Regression with Repeated Nested CV")
print("============================================================")
...
print("\nDATASET OVERVIEW")
print("------------------------------------------------------------")
print(f"Full metabolomics matrix shape: {X_all.shape}")
print(f"Serum samples: {X_serum.shape}")
print(f"Urine samples: {X_urine.shape}")

print("\nClass distribution (Serum samples only)")
print("1 = Chronic Fatigue Syndrome (CFS)")
print("0 = Control")
print(y_serum.value_counts())
print("------------------------------------------------------------")

# ---- Naive (optimistic) ----
naive_auc, naive_params = naive_cv_estimate(X_serum, y_serum)
print("\n============================================================")
print("Naive Cross-Validation Performance (Optimistic Estimate)")
print("============================================================")
print("This estimate performs hyperparameter tuning and evaluation")
print("on the same cross-validation folds. This generally results")
print("in an optimistic estimate of predictive performance.")
print("")
print(f"Estimated ROC-AUC: {naive_auc:.4f}")
...
print("\n============================================================")
print("Repeated Nested Cross-Validation (Unbiased Estimate)")
print("============================================================")
print("Nested cross-validation separates model tuning and evaluation,")
print("providing a less biased estimate of real-world performance.")
print("")
print(f"Total outer evaluations: {len(outer_aucs)}")
print(f"Configuration: REPEATS={REPEATS}, OUTER_SPLITS={OUTER_SPLITS}")
print("")
print("Model discrimination (ROC-AUC)")
print(f"Mean AUC: {m_auc:.4f}")
print(f"Standard deviation: {s_auc:.4f}")
print(f"95% confidence interval: ({ci_auc[0]:.4f}, {ci_auc[1]:.4f})")
print("")
print("Model calibration (Brier score)")
print(f"Mean Brier score: {m_br:.4f}")
print(f"Standard deviation: {s_br:.4f}")
print(f"95% confidence interval: ({ci_br[0]:.4f}, {ci_br[1]:.4f})")
print("------------------------------------------------------------")

print("\nModel Optimism Gap")
print("------------------------------------------------------------")
print("Difference between naive CV estimate and nested CV estimate.")
print("This quantifies how much performance inflation occurs when")
print("hyperparameter tuning and evaluation use the same folds.")
print("")
print(f"Optimism gap (Naive AUC − Nested AUC): {(naive_auc - m_auc):.4f}")
print("------------------------------------------------------------")
...
print("============================================================")
print("Feature stability was assessed across outer CV models using")
print("the Jaccard similarity coefficient between selected feature sets.")
print("")
print(f"Mean Jaccard similarity: {np.nanmean(j_scores):.4f}")
print(f"Number of pairwise model comparisons: {len(j_scores)}")
print("------------------------------------------------------------")

# print top 10 most frequently selected features
total_models = len(selected_sets)
print("\nTop 10 most frequently selected metabolites")
print("------------------------------------------------------------")
for f, c in sorted(freq.items(), key=lambda x: -x[1])[:10]:
    print(f"{f}")
    print(f"  Selected in {c} / {total_models} models ({c/total_models:.1%})")
print("============================================================")